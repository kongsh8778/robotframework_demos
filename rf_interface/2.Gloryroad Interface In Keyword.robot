...
*** Test Cases ***
Valid Test
    #    register    xiaoxiao    00    &{True}
    login    ksh1111    ${PASSWORD}    00
    #create    hello    robot    00
    getBlogContent    1    00

Invalid Test
    # 用户名为空格
    register    ${SPACE}    02    ${False}
    # 用户已存在
    register    ksh1111    01    ${False}
    # 登录的用户不存在
    login    kongsh1    ${PASSWORD}    03
    # 登录的密码不正确
    login    ksh1111    2514836    03
